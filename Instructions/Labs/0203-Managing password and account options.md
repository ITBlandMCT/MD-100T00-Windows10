...
```
    Invoke-Command -ComputerName SEA-DC1.contoso.com -ScriptBlock {GPUpdate /force}
```

3. Close the **Windows PowerShell** and the **Active Directory Users and Computers** window.
